do function run(msg, matches)
  ...
  return "اسم من دالاد هستش اسم تو چیه؟"
  end
...
if matches[1]:lower() == 'چطوری' then
  ...
  if matches[1]:lower() == 'این کیه پسرم' then
  return "کیرتم نیس بابایی جون"
end
  if matches[1]:lower() == 'مریم' then
  return "با مامانیم چیکار داری؟"
end
if matches[1]:lower() == 'gp' then
  return "گروه قیمتش 5 تومنه"
 end
